...
<div class="widget widget_darkblue col-lg-2 col-sm-2 col-xs-2 bt" style="margin-left: 6%" data-toggle="modal" data-target="#Liste_etudiants">
...
<div class="col-lg-8 col-sm-12 col-xs-12 col-lg-offset-2">
	<div class="list-group">
	  ...
	  <a ng-click="detail_etudiant(student.Student.nom,student.Student.prenom,student.Student.id,student.Student.matricule)" class="list-group-item Student-item" ng-repeat="student in Students | filter:{Student : {nom:search,cycle:filiere}}" >
