...
Tél. 32/2/640.88.83. - Télécopieur : 32/2/649.41.09.
    ...
    <b style="font-weight:bold;font-size:22px;margin-left:220px;">ATTESTATION D’INSCRIPTION</b><br><br>
<br><br>
        </page_header> 
        <page_footer>
    [[page_cu]]/[[page_nb]]
                    ...
                    <b style='text-align:center;margin-left: 120px;'><u>destinée à la commune en vue de l’obtention ou de la prolongation du C.I.R.E. </u></b>
                    <br><br>

                    <p style='line-height:30px;'>Je soussigné, Michel Legrand, Administrateur délégué de l'Institut de Formation de Cadres pour le Développement, certifie que
...
est inscrit(e) à l’IFCAD dans la section Formation des Cadres pour l’année académique <?php echo $data5['annee']; ?>   



La présente attestation - sans rature ni surcharge - n’est délivrée qu’à un seul exemplaire par année académique et doit, pour être valable, porter le cachet en relief dans la signature et le cachet à l'encre rouge. 

Il est porté à la connaissance de l’étudiant bénéficiaire de la présente attestation d’inscription qu’il doit se présenter à l’IFCAD dans le <u>le délai de 15 jours calendrier, prenant cours à la date de sortie de son pays d’origine </u>.<b> Faute de quoi, son inscription sera refusée.

En foi de quoi, cette attestation est délivrée pour servir et valoir ce que de droit.</b></p>
