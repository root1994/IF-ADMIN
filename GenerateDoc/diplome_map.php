...
<p style="margin-left:70px;text-align:center;font-size:22px;"><?php echo substr($data5['annee'], 0, 4) ." - ". substr($data5['annee'], -4) ; ?></p><br>
        ...
        <page_footer>
                    ...
                    <p style='line-height:23px;'>
                      Nous, Président et Membres du Jury, chargés par le Conseil d'Administration de l'Institut de Formation de Cadres pour le Développement, sis à Bruxelles (Belgique), de conférer le DIPLÔME de <i>MAITRISE EN ADMINISTRATION PUBLIQUE</i>,<br> 
...
Economie politique; finances publiques et problématique de la dette publique des pays en voie de développement ;  théorie des marchés publics (aspects financiers et juridiques); principes généraux de fiscalité; management ; droit administratif, contentieux administratif; principes généraux  de statut du personnel et questions  spéciales de déontologie ; droit budgétaire; droits de l’homme ; internet juridique et administratif ; développement local et aménagement du territoire ; les pays de développement situés dans leurs relations internationales ; démographie ; développement durable et gestion de l’environnement ;  rédaction administrative; apprentissage du système windows ; initiation aux logiciels de base ;  initiation à Internet ; anglais.</i></p>
